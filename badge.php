...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    if (isset($_POST['submit'])) {
        ...
        $course_sql="INSERT INTO `badge`( `badge_name`,`c_id`) VALUES ('$badge','$c_name')";
        if ($course="") {
            ?>
        <script>
                        ...
                        <div class="box box-primary">
                            ...
                            <form method="post">
                                <div class="form-group col-md-6 col-lg-6">
                                    <select class="form-control " name="cname" id="t_name">
                   ...
                   ?>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 col-lg-6">
                                        ...
                                        <input type="text"placeholder="Enter Badge" name="badge" class="form-control" id="inputEmail4">
                                    </div>
