                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                ...
                                <a href="./all_course.php" class="btn btn-success" style="float:right">Add Course</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <?php 
                                          $view_sql= "SELECT * FROM `all_course`";
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        ...
                                                        style="width:150px; margin-top:15px" href="./includes/del_course.php?courseid=<?php echo $fetch['course_id']?>">Delete</a><br><br>
